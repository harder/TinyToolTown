...
featured: false
ai_summary: "See exactly what’s different between two winget export JSON files with a stunning and easy-to-read terminal diff that makes comparing machines a breeze and a joy to behold!"
ai_features: ["🔥 Gorgeous ANSI-colored terminal UI", "⚡ Zero dependencies for easy setup", "🎯 Side-by-side diff of winget export JSON files", "💻 Perfect for spotting package differences between Windows machines"]
---
